			...
			<section class="panel panel_view p-tl">
				<div class="contract">	  
							...
							<div class="contract-item">					
									<h3 class="contract-header">Договор №525 от 21.02.2021</h3>
				...
				<div class="p-tb devices">
					...
					<div class="box "> 
						<div class="devices-item">
							<a href="dev.php" class="link-shadow">
					    ...
					    <div class="devices-item">
							<a href="" class="link-shadow">
								<ul class="devices-detalies">
									...
									<li  class="devices-detalies-item">
										<span class="par par_clock">Дата списания </span>
										<span class="val ">28.07.2021</span>
									</li>
									<li  class="devices-detalies-item">
										<span class="par par_place">Место </span>
										<span class="val ">Бокс3</span>
									</li>
								</ul>
							</a>
					    </div>
