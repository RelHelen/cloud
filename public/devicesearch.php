					...
					<div class="device"> 
						<div class="device-item ">							
								<ul class="device-detalies ">									
									<li class="device-detalies-item ">
										<span class="val large-txt error-txt">15616</span>											
										<span class="par_connect par_connect_error"></span>										 									
									</li>
									<li class="device-detalies-item ">
										<span class="par ">qr_pay</span>									 
										<span class="par small-txt">24.07.2021</span>	
									</li>																			
					    ...
					    <div class="device-item ">							
								<ul class="device-detalies ">									
									...
									<li class="device-detalies-item ">
										<span class="par ">qr_pay</span>									 
										<span class="par small-txt error-txt">24.07.2021</span>	
									</li>																			
					    ...
					    <div class="device-item ">							
								<ul class="device-detalies ">									
									...
									<li class="device-detalies-item ">										
										<span class="val">
											<span class="large-txt">300</span>
											<span class="par">&#8381;</span>
										</span>

										<span class="val success-txt">24.07.2021 13:10</span>
									</li>
